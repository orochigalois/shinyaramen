...
<div id="inner-map">
	<div id="inner-boxlocation" class='inner-boxlocation__left'>
...
<div class="inner-forms">
	<button class="open_form_contact_us">Contact us</button>
	<button class="open_form_work">Working with us</button>
	<?php if(false): ?>
	<button class="open_form_franchise">Franchise with us</button>
	<?php endif; ?>
	<a class="sister_shops" href="#">Our sister shops</a>
...
<script>
	$(document).ready(function() {
		...
		$('.open_form_contact_us').click(function() {
			$('.form_contact_us').show();
		});
		$('.open_form_work').click(function() {
			$('.form_work').show();
		});
		$('.open_form_franchise').click(function() {
			$('.form_franchise').show();
		});
